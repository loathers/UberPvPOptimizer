...
pvpGear["showAllItemsf"] = 0;				// When 0.0, only shows items you own or within mall budget
pvpGear["buyGearf"] = 0;					// Will auto-buy from mall if below threshold price and better than what you have
...
pvpGear["displayUnownedBling"] = 0;	// Set to false to prevent the item outputs from showing items worth [bling] or more
